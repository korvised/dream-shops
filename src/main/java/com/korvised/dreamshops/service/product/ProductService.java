...
import com.korvised.dreamshops.exceptions.ProductNotFoundException;
...
import com.korvised.dreamshops.repository.product.ProductRepository;
...
public class ProductService implements IProductService {
    ...
    public Product getProductById(Long id) {
        return productRepository
                .findById(id)
                .orElseThrow(() -> new ProductNotFoundException("Product found"));
    }
